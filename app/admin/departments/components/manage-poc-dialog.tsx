...
export function ManagePOCDialog({
  ...
  useEffect(() => {
    setLocalPOCs(department.poc_department_access || [])
  }, [department.poc_department_access])
  ...
  const handleGrantAccess = async (pocId: string) => {
  ...
  const handleRevokeAccess = async (pocId: string) => {
